...
<!-- Some sort of catchy introduction -->

Here in the SPU Developers club, our goal is to foster community among the Computer Science and Engineering students at Seattle Pacific, as well as to help our fellow students prepare to join the workforce of software developers. We do this a number of ways, including club projects, workshops, business tours, LAN parties, and our annual hackathon.
<!--more-->
...
Throughout the year, we'll have a number of events that anyone can attend. We recommend subscribing to the [#events channel](https://spudevelopers.slack.com/messages/C2H6Y99EG) in our Slack for updates. You can also subscribe to our calendar using the handy "Subscribe" button in this website's sidebar.
...
Over the course of the year, various members of SPUD will be able to host workshops to teach some topic relating to software development. This will often be lead by one of the officers and relate to the development of a club project, but other members are welcome to contact an officer about hosting their own workshop. The best option is to send a message in the [#workshops channel](https://spudevelopers.slack.com/messages/C7AT2J8AJ) on Slack, but email and face-to-face work too.
...
<!-- Need more information about the hackathon -->
...
You can sign up for a Slack account using your `@spu.edu` email address [here](https://spudevelopers.slack.com/signup/). We recommend joining the [`#general`](https://spudevelopers.slack.com/messages/C26JFFXPW), [`#events`](https://spudevelopers.slack.com/messages/C2H6Y99EG), and [`#workshops`](https://spudevelopers.slack.com/messages/C7AT2J8AJ) channels, plus the [`#interview`](https://spudevelopers.slack.com/messages/C7J4TEWHM) channel if you want to prepare for coding interviews.
